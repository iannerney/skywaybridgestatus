...
const PrimaryStatus = () => {
    return (
        ...
        >
            ...
            <Text>
                <Link href="https://www.skywaybridgestatus.com/&refresh=true">Refresh this page</Link> for the latest
                data.
            </Text>
            <Text>
                We update our main status every 5 minutes from <Link href="https://fl511.com/List/Alerts">FL511</Link>.
            </Text>
